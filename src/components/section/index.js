        ...
        <div className="py-5">
            <div className="container col-md-8 mb-5 mt-5">
                <div className="row">
                    ...
                    <p className="lead font-style-2">We are making a difference in the puppy breeding world.
                ...
                <div className="row">
                    <h1 className="font-style-1">Our Promise:</h1>
                    <p className="lead font-style-2">We are not a puppy mill. Each of our Parent dogs are treated as family members.
